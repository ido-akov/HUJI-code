...
class Screen:
    ...
    def _bind_keys(self):
        ...
        self._bind_key("t", self._handle_teleport)
    ...
    def is_teleport_pressed(self):
        """
        :return: True if the teleport key was pressed, else False
        """
        res = self._teleportClicks > 0
        self._teleportClicks -= 1 if res else 0
        return res
